...
function check() {
  ...
  if (cell1 == cell2 && cell2 == cell3 && cell1 == cell3 && cell1 !== "") {
    ...
    alert("Tie!");
      ...
      gameHistory("Nobody", " wins this round!", " Get it the fuck together.");
  }
}
...
function gameHistory (winner, outputText) {
  var node;
  var pChildNode = document.createElement("p");
